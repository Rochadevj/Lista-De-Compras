...
Você pode [acessar o código fonte do projeto inicial]() ou [baixá-lo](https://github.com/alura-cursos/3801-javascript-para-web/archive/refs/heads/projeto-base.zip).
